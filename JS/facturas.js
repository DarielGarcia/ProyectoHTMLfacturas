var UrlGetFacturas ='http://localhost:90/G4_20/controller/facturas.php?op=GetFacturas';
var UrlPostFactura ='http://localhost:90/G4_20/controller/facturas.php?op=InsertFactura';
var UrlPutFactura ='http://localhost:90/G4_20/controller/facturas.php?op=UpdateFactura';
var UrlGetFactura ='http://localhost:90/G4_20/controller/facturas.php?op=GetFactura';
var UrlDeleteFactura ='http://localhost:90/G4_20/controller/facturas.php?op=DeleteFactura';
